...
<div class="main-block">
    <div class="icon-templatemela"><img src="<?php echo esc_attr(get_option('siteurl')) . '/wp-content/themes/' . get_option('template') . '/templatemela/logo.png'; ?>"/>
    </div>
        ...
        <form enctype="multipart/form-data" method="post" id="settingForm1" name="settingForm1">
            ...
            <div class="form-table">
                <div class="main_title">
                    <h3>
                        <?php esc_attr_e('Hook Manager', 'sheon'); ?>
                    </h3>
                </div>
                <?php
                $i = 0;
