...
$options1[] = array("id" => "tmpmela_show_site_loader",
    "label" => __("Show Site Loader",'smarteye'),
    "type" => "select",
    "description" => __("Displays Site Loader.", 'smarteye'),
...
$options2[] = array("id" => "tmpmela_header_topbkg_color",
    "label" => "Header Top Background Color",
    "type" => "textbox-1",
    "std" => "F6F6F8",
    "description" => "Change your header top background color. ");
$options2[] = array("id" => "tmpmela_header_topbkg_opacity",
    "label" => "Header Top Background Opacity",
    "type" => "textbox",
    "std" => "1",
    "description" => "Change your header top background opacity e.g. ( 0.0 to 1 )");
$options2[] = array("id" => "tmpmela_header_bottombkg_color",
    "label" => "Header Bottom Background Color",
    "type" => "textbox-1",
    "std" => "F6F6F8",
    "description" => "Change your header bottom background color. ");
$options2[] = array("id" => "tmpmela_header_bottombkg_opacity",
    "label" => "Header Bottom Background Opacity",
    "type" => "textbox",
    "std" => "1",
    "description" => "Change your header bottom background opacity e.g. ( 0.0 to 1 )");
$options2[] = array("id" => "tmpmela_header_toptext_color",
    "label" => "Header Top Text Color",
    "type" => "textbox-1",
    "std" => "8A8A8A",
    "description" => "Change your header top text color");
$options2[] = array("id" => "tmpmela_header_toptexthover_color",
    "label" => "Header Top Text Hover Color",
    "type" => "textbox-1",
    "std" => "f22b2b",
    "description" => "Change your header top text hover color");
/*===================================================================================================================
...
$options2[] = array("label" => "Navigation Menu Setting",
    ...
    "type" => "Title-1");
$options2[] = array("id" => "tmpmela_menu_activelink_color",
    "label" => "Navigation active link color",
    "type" => "textbox-1",
    "std" => "000000",
    "description" => "Change active link color of navigation menu");
$options2[] = array("id" => "tmpmela_menu_activelinkhover_color",
    "label" => "Navigation active link hover color",
    "type" => "textbox-1",
    "std" => "000000",
    "description" => " Change active link hover color of navigation menu");
$options2[] = array("id" => "tmpmela_menu_parentlink_color",
    "label" => "Navigation parent link color",
    "type" => "textbox-1",
    "std" => "000000",
    "description" => "Change parent link color of navigation menu");
$options2[] = array("id" => "tmpmela_menu_parentlinkhover_color",
    "label" => "Navigation parent link hover color",
    "type" => "textbox-1",
    "std" => "f22b2b",
    "description" => " Change parent link hover color of navigation menu");
$options2[] = array("id" => "tmpmela_menu_childlink_color",
    "label" => "Navigation child link color",
    "type" => "textbox-1",
    "std" => "000000",
    "description" => " Change child link color of navigation menu");
$options2[] = array("id" => "tmpmela_menu_subchildlink_color",
    "label" => "Navigation Sub-Child link color",
    "type" => "textbox-1",
    "std" => "000000",
    "description" => " Change sub-child link color of navigation menu");
$options2[] = array("id" => "tmpmela_menu_childlinkhover_color",
    "label" => "Navigation Sub-Child link hover color",
    "type" => "textbox-1",
    "std" => "f22b2b",
    "description" => " Change sub-child link hover color of navigation menu");
/*===================================================================================================================
=============================================== Contact Detail Settings ====================================================
=================================================================================================================== */
$options2[] = array("label" => "Contact Detail Setting",
    "title" => "Contact Detail Setting",
    "type" => "Title-1");
$options2[] = array("id" => "tmpmela_show_contact",
    "label" => "Show Contact Detail",
    "type" => "select",
    "description" => "Display Contact Detail.",
    "options" => array('yes' => 'Yes', 'no' => 'No'));
$options2[] = array("id" => "tmpmela_contact_text_color",
    "label" => "Contact text color",
    "type" => "textbox-1",
    "std" => "ffffff",
    "description" => "Change your text color of contact");
$options2[] = array("id" => "tmpmela_contact_number",
    "label" => "Contact Number",
    "type" => "textbox",
    "std" => "1.820.3345.33",
    "description" => "Contact Number.");
$options2[] = array("id" => "tmpmela_contact_email",
    "label" => "Contact Email",
    "type" => "textbox",
    "std" => "Contact@TravelTourWP.com",
    "description" => "Contact Email.");
/*===================================================================================================================
=============================================== Offer Text Settings ====================================================
=================================================================================================================== */
$options2[] = array("label" => "Offer Text Setting",
    "title" => "Offer Text Setting",
    "type" => "Title-1");
$options2[] = array("id" => "tmpmela_show_offer",
...
$options2[] = array("id" => "tmpmela_offer_text",
    "label" => "Offer text",
    "type" => "textbox",
    "std" => "Free shipping for all order over $1000",
    "description" => "Free shipping for all order over $1000");
/*===================================================================================================================
=============================================== Content Settings ====================================================
=================================================================================================================== */
...
$options4[] = array("id" => "tmpmela_footer_slog",
    ...
    "std" => "Templatemela, All Rights Reserved.");
//=============================================== Shop Settings ==================================================================
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) :
    ...
    $options7[] = array("id" => "tmpmela_shop_sidebar",
        ...
        "options" => array('no' => 'No', 'yes' => 'Yes'));
    $options7[] = array("label" => "Sidebar setting for other pages",
        "title" => "Sidebar setting for other pages",
        "type" => "Title-1");
    $options7[] = array("id" => "tmpmela_page_sidebar",
...
<div class="main-block">
        ...
        <div class="wrap">
            ...
            <div class="tmpmela_contents">
                <div class="entry-content">
                    <p><a target="_Self" href="#" title="<?php esc_html_e('Templatemela', 'sheon'); ?>">TemplateMela</a>
                        <br/>
    ...
    <div class="tab_main">
        ...
        <div id="tab-container" class='tab-container'>
            <ul class='etabs'>
                <li class="tab first"><a href="#General" title="<?php esc_html_e('General Settings', 'sheon'); ?>"><img
                                src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/general_setting.png"
                                alt="<?php echo esc_attr_e('general', 'sheon'); ?>"/> <span class="title">
      <?php echo esc_attr_e('General', 'sheon'); ?>
      </span></a></li>
                <li class="tab header"><a href="#Header"><img
                                src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/header_setting.png"
                                alt="<?php echo esc_attr_e('header', 'sheon'); ?>"/> <span class="title">
      <?php echo esc_attr_e('Header', 'sheon'); ?>
      </span></a></li>
                <li class="tab"><a href="#Content"><img
                                src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/content_settings.png"
                                alt="<?php echo esc_attr_e('content', 'sheon'); ?>"/> <span class="title">
      <?php echo esc_attr_e('Content', 'sheon'); ?>
      </span></a></li>
                <li class="tab"><a href="#Footer"><img
                                src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/footer_settings.png"
                                alt="<?php echo esc_attr_e('footer', 'sheon'); ?>"/> <span class="title">
      <?php echo esc_attr_e('Footer', 'sheon'); ?>
      </span></a></li>
                <?php if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) : ?>
                    <li class="tab"><a href="#product"><img
                                    src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/product_setting.png"
                                    alt="<?php echo esc_attr_e('product', 'sheon'); ?>"/> <span class="title">
      <?php echo esc_attr_e('Product', 'sheon'); ?>
      </span></a></li>
                <?php endif; ?>
            </ul>
                    ...
                    <form enctype="multipart/form-data" method="post" id="settingForm1" name="settingForm1">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_attr_e('General Settings', 'sheon'); ?>
                                </label>
                            </div>
                            <?php
                            $i = 0;
                ...
                <div id="Header">
                    <form enctype="multipart/form-data" method="post" id="settingForm2" name="settingForm2">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_attr_e('Header Settings', 'sheon'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options2
                ...
                <div id="Content">
                    <form enctype="multipart/form-data" method="post" id="settingForm3" name="settingForm3">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_attr_e('Content Settings', 'sheon'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options3
                ...
                <div id="Footer">
                    <form enctype="multipart/form-data" method="post" id="settingForm4" name="settingForm4">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_attr_e('Footer Settings', 'sheon'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options4
                                            ...
                                            <?php if (get_option('tmpmela_footer_background_upload') != '') { ?>
                                                <img src="<?php echo esc_url(get_option('tmpmela_footer_background_upload')); ?>"
                                                     id="slider_backgrounddisplay1" class="thumb"/>&nbsp;<a
                                                        id="slider_remove_link31"
                                                        href="javascript:tmpmela_removeImage32();"><img
                                                            src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/remove.png"/></a>
                                            <?php } ?>
                                            <script>
                                                function tmpmela_removeImage32() {
                                                    document.getElementById("tmpmela_footer_background_upload").value = "";
                                                    document.getElementById("slider_backgrounddisplay1").src = "";
                                                    document.getElementById("slider_remove_link32").innerHTML = "";
                                                }
                                            </script>
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="even setting_main">
                                            ...
                                            <div class="title">
                                                ...
                                                <?php if (get_option('tmpmela_footerheader_background_upload') != '') { ?>
                                                    <img src="<?php echo esc_url(get_option('tmpmela_footerheader_background_upload')); ?>"
                                                         id="slider_backgrounddisplay1" class="thumb"/>&nbsp;<a
                                                            id="slider_remove_link31"
                                                            href="javascript:tmpmela_removeImage33();"><img
                                                                src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/remove.png"/></a>
                                                <?php } ?>
                                                <script>
                                                    function tmpmela_removeImage33() {
                                                        document.getElementById("tmpmela_footerheader_background_upload").value = "";
                                                        document.getElementById("slider_backgrounddisplay1").src = "";
                                                        document.getElementById("slider_remove_link33").innerHTML = "";
                                                    }
                                                </script>
                                            </div>
                                            <div class="content">
