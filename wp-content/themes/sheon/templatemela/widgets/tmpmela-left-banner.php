...
class LeftBannerWidget extends WP_Widget
{
    ...
    {
        $widget_settings = array('description' => 'Display banner for sidebar ', 'classname' => 'widgets-leftbanner');
    ...
    function widget($args, $instance)
    {
        ...
        <div class="left-banner">
            <a href="<?php if ($linkURL == ""): echo esc_url(home_url('/')); else: ?><?php echo esc_url($linkURL); endif; ?>"
                ...
                <img src="<?php echo esc_url($imageSrc1); ?>" alt="<?php echo esc_attr_e('leftbanner', 'sheon'); ?>"
                     class="vv"/>
            </a>
        </div>
        <?php
    ...
    function form($instance)
    {
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('imageSrc1')); ?>">Image URL:<br/></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('imageSrc1')); ?>"
                   name="<?php echo esc_attr($this->get_field_name('imageSrc1')); ?>" type="text"
                   value="<?php echo esc_attr($imageSrc1); ?>"/><br/>
            <input class="checkbox" type="checkbox" <?php checked($instance['is_template_path1'], true) ?>
                   id="<?php echo esc_attr($this->get_field_id('is_template_path1')); ?>"
                   name="<?php echo esc_attr($this->get_field_name('is_template_path1')); ?>"/><label
                    for="<?php echo esc_attr($this->get_field_id('is_template_path1')); ?>">Use Template Path for
                Image</label>
        </p>
        <p>
