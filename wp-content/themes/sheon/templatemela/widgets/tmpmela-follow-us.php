...
class FollowMeWidget extends WP_Widget
{
    ...
    {
        $widget_settings = array('description' => 'Display social icon with links', 'classname' => 'widgets-follow-us');
            ...
            <ul class="toggle-block">
                <li>
                    <?php if (!empty($linkURL1)) : ?>
                        <a href="<?php echo esc_url($linkURL1); ?>" title="<?php echo esc_attr('Facebook', 'sheon'); ?>" class="facebook icon"><i class="fa fa-facebook"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL2)) : ?>
                        <a href="<?php echo esc_url($linkURL2); ?>" title="<?php echo esc_attr('Twitter', 'sheon'); ?>" class="twitter icon"><i class="fa fa-twitter"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL3)) : ?>
                        <a href="<?php echo esc_url($linkURL3); ?>" title="<?php echo esc_attr('Linkedin', 'sheon'); ?>" class="linkedin icon"><i class="fa fa-linkedin"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL4)) : ?>
                        <a href="<?php echo esc_url($linkURL4); ?>" title="<?php echo esc_attr('RSS', 'sheon'); ?>" class="rss icon"><i class="fa fa-rss"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL5)) : ?>
                        <a href="<?php echo esc_url($linkURL5); ?>" title="<?php echo esc_attr('Youtube', 'sheon'); ?>" class="youtube icon"><i class="fa fa-youtube"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL6)) : ?>
                        <a href="<?php echo esc_url($linkURL6); ?>" title="<?php echo esc_attr('Pinterest', 'sheon'); ?>" class="pinterest icon"><i class="fa fa-pinterest"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL7)) : ?>
                        <a href="<?php echo esc_url($linkURL7); ?>" title="<?php echo esc_attr('Google Plus', 'sheon'); ?> " class="google-plus icon"><i class="fa fa-google-plus"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL8)) : ?>
                        <a href="<?php echo esc_url($linkURL8); ?>" title="<?php echo esc_attr('Skype', 'sheon'); ?>" class="skype icon"><i class="fa fa-skype"></i></a>
                    <?php endif; ?>
                    <?php if (!empty($linkURL9)) : ?>
                        <a href="<?php echo esc_url($linkURL9); ?>" title="<?php echo esc_attr('Instagram', 'sheon'); ?>" class="instagram icon"><i class="fa fa-instagram"></i></a>
                    <?php endif; ?>
                </li>
            </ul>
        </div>
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('linkURL9')); ?>"
                   name="<?php echo esc_attr($this->get_field_name('linkURL9')); ?>" type="text"
