...
function woocommerce_header_add_to_cart_fragment($fragments)
{
    ...
    ob_start();
    ?>
    <a class="cart-contents" title="<?php esc_attr_e('View your shopping cart', 'sheon'); ?>">
        <?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'sheon'), $woocommerce->cart->cart_contents_count); ?></a>
    <?php
