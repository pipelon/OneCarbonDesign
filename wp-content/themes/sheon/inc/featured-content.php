...
class tmpmela_Featured_Content
{
    ...
    public static function customize_register($wp_customize)
    {
        $wp_customize->add_section('tmpmela_Featured_Content', array(
            ...
            'description' => sprintf(__('Use a <a href="%1$s">tag</a> to feature your posts. If no posts match the tag, <a href="%2$s">sticky posts</a> will be displayed instead.', 'sheon'),
                esc_url(add_query_arg('tag', _x('featured', 'featured content default tag slug', 'sheon'), admin_url('edit.php'))),
        ...
        $wp_customize->add_control('featured-content[tag-name]', array(
            'label' => esc_html__('Tag Name', 'sheon'),
            'section' => 'tmpmela_Featured_Content',
            'priority' => 20,
        ));
        $wp_customize->add_control('featured-content[hide-tag]', array(
            'label' => esc_html__('Don&rsquo;t display tag on front end.', 'sheon'),
            'section' => 'tmpmela_Featured_Content',
            'type' => 'checkbox',
            'priority' => 30,
        ));
