...
{
    $message = sprintf(esc_html__('TemplateMela requires at least WordPress version 3.6. You are running version %s. Please upgrade and try again.', 'sheon'), $GLOBALS['wp_version']);
...
{
    wp_die(sprintf(esc_html__('TemplateMela requires at least WordPress version 3.6. You are running version %s. Please upgrade and try again.', 'sheon'), $GLOBALS['wp_version']), '', array(
        'back_link' => true,
    ));
}
...
function tmpmela_preview()
{
    if (isset($_GET['preview'])) {
        wp_die(sprintf(esc_html__('TemplateMela requires at least WordPress version 3.6. You are running version %s. Please upgrade and try again.', 'sheon'), $GLOBALS['wp_version']));
    }
}
