        ...
        <div class="archive-content">
            ...
            <div class="sitemap-item">
                <div class="sitemap-category">
                    <h2>
                        <?php esc_html_e('Category Archives', 'sheon'); ?>
                    </h2>
                    <ul>
                        <?php wp_list_categories(array('feed' => esc_html__('RSS', 'sheon'), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false)); ?>
                    </ul>
                </div>
                <div class="clear"></div>
                <div class="sitemap-month-archieves">
                    <h2>
                        <?php esc_html_e('Monthly Archives', 'sheon'); ?>
                    </h2>
                    <ul>
                ...
                <div class="sitemap-authors">
                    <h2>
                        <?php esc_html_e('Author Archives', 'sheon'); ?>
                    </h2>
                    <ul>
            ...
            <div class="sitemap-item">
                <div class="sitemap-posts">
                    <h2>
                        <?php esc_html_e('Blog Posts', 'sheon'); ?>
                    </h2>
                    <ul>
                        <?php
