...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - Short Description', 'sheon'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - Post Options', 'sheon'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
	'fields' 	=> array(
		...
		array(
			'name'    		=> esc_html__('Show Related Posts on single post:', 'sheon'),
		...
		array(
			'name'    		=> esc_html__('Show Author Info on single post:', 'sheon'),
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - List Options', 'sheon'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
	'fields' 	=> array(	
		...
		array(
			'name'			=> esc_html__('Number of posts per page:', 'sheon'),
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - Box Options', 'sheon'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
	'fields' 	=> array(	
		...
		array(
			'name'    		=> esc_html__('Display Options:', 'sheon'),
			'id'      		=> "{$prefix}display",
			'type'    		=> 'radio',
			'std'			=> 'grid',
			'options'		=> array(
		...
		array(
			'name'    		=> esc_html__('Columns Options:', 'sheon'),
			'id'      		=> "{$prefix}columns",
			'type'    		=> 'radio',
			'std'			=> 'two',
			'options'		=> array(
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - Filter Options', 'sheon'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
